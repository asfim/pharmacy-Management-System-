...
<aside class="fixed inset-y-0 left-0 z-50 w-64 bg-slate-900 text-white transition-transform duration-300 ease-in-out"
    ...
    <nav class="p-3 h-[calc(100vh-4rem)] overflow-y-auto">
        ...
        <a href="{{ route('admin.stock.index') }}" class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg hover:bg-slate-800 hover:text-white mb-1 {{ request()->routeIs('admin.stock.index') ? 'bg-slate-800 text-white' : 'text-slate-300' }}">
        ...
        <a href="{{ route('admin.stock-transfers.index') }}" class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg hover:bg-slate-800 hover:text-white mb-1 {{ request()->routeIs('admin.stock-transfers*') ? 'bg-slate-800 text-white' : 'text-slate-300' }}">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"></path></svg>
            Stock Transfers
        </a>
        ...
        <a href="{{ route('admin.payrolls.index') }}" class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg hover:bg-slate-800 hover:text-white mb-1 {{ request()->routeIs('admin.payrolls*') ? 'bg-slate-800 text-white' : 'text-slate-300' }}">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
            Payroll
        </a>
        ...
        <a href="{{ route('admin.sliders.index') }}" class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg hover:bg-slate-800 hover:text-white mb-1 {{ request()->routeIs('admin.sliders*') ? 'bg-slate-800 text-white' : 'text-slate-300' }}">
        ...
        <a href="{{ route('admin.cms.index') }}" class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg hover:bg-slate-800 hover:text-white mb-1 {{ request()->routeIs('admin.cms*') ? 'bg-slate-800 text-white' : 'text-slate-300' }}">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
            Homepage Features
        </a>
        <a href="{{ route('admin.testimonials.index') }}" class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg hover:bg-slate-800 hover:text-white mb-1 {{ request()->routeIs('admin.testimonials*') ? 'bg-slate-800 text-white' : 'text-slate-300' }}">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"></path></svg>
            Testimonials
        </a>
