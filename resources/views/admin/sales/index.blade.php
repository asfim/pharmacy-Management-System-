    ...
    <div class="overflow-x-auto">
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-slate-50">
                ...
                @empty
                <tr><td colspan="9" class="px-5 py-10 text-center text-slate-400">No sales yet. <a href="{{ route('admin.pos.index') }}" class="text-teal-600 hover:underline">Create a sale →</a></td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
