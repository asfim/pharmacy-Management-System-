    ...
    <div class="overflow-x-auto">
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-slate-50">
                ...
                @empty
                <tr><td colspan="7" class="px-5 py-10 text-center text-slate-400">No suppliers found. @can('create suppliers')
 <a href="{{ route('admin.suppliers.create') }}" class="text-teal-600 hover:underline">Add one →</a>
 @endcan</td></tr>
                @endforelse
            </tbody>
        </table>
