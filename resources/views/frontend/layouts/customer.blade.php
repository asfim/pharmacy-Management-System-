...
<div class="cd-wrapper">
    ...
    <aside class="cd-sidebar" id="cdSidebar">
        ...
        <nav class="cd-nav">
            ...
            <a href="{{ route('customer.dashboard') }}" class="cd-nav-item {{ request()->routeIs('customer.dashboard') ? 'active' : '' }}">
                <span class="nav-icon"><svg class="w-5 h-5 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg></span> Dashboard
            </a>
            <a href="{{ route('customer.orders') }}" class="cd-nav-item {{ request()->routeIs('customer.orders') ? 'active' : '' }}">
            ...
            <a href="{{ route('customer.prescriptions') }}" class="cd-nav-item {{ request()->routeIs('customer.prescriptions') ? 'active' : '' }}">
            ...
            <a href="{{ route('customer.profile') }}" class="cd-nav-item {{ request()->routeIs('customer.profile') ? 'active' : '' }}">
            ...
            <a href="{{ route('customer.addresses') }}" class="cd-nav-item {{ request()->routeIs('customer.addresses') ? 'active' : '' }}">
            ...
            <a href="{{ route('customer.security') }}" class="cd-nav-item {{ request()->routeIs('customer.security') ? 'active' : '' }}">
        ...
        <div class="cd-topbar">
            ...
            <div class="cd-topbar-right">
                ...
                <form method="POST" action="{{ route('logout') }}" style="margin: 0;">
                    @csrf
                    <button type="submit" class="cd-topbar-btn text-danger hover:bg-red-50 hover:text-red-600" title="Logout" style="width:auto; padding:0 12px; font-size:14px; font-weight:600;">
