                    ...
                    @else
                        ...
                        <div>
                            <span class="text-2xl font-extrabold tracking-tight">
                                <span class="bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">{{ isset($siteSettings['site_title']) ? strtok($siteSettings['site_title'], ' ') : 'PHARMA' }}</span><span class="text-slate-800">{{ isset($siteSettings['site_title']) ? substr($siteSettings['site_title'], strpos($siteSettings['site_title'], ' ')) : 'SYS' }}</span>
                            </span>
                        </div>
                    @endif
                </a>
